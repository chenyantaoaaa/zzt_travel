...
public class CookieUtil {
	...
	private final static String cookieDomainName = "com.cyt";
	// 加密cookie时的网站自定码
	private final static String webKey = "cyt";
	...
	public static void saveCookie(UserInfo user, HttpServletResponse response) {
